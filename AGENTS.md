# roc-job-radar — Codex Instructions
...
packages/frontend/  React + Vite frontend (implemented and tested)
...
- include "Co-authored-by: Codex" or any Codex attribution
- include "Generated by Codex", "AI assisted", or similar trailers

Codex should **never add its name or attribution** to commits.
...
- **Frontend is implemented.** Follow current frontend guidance in `CLAUDE.md`; defer additional UI scope changes unless requested.
